...
from src.myideas.swin_transformer.backbones.swin_transformer import SwinTransformer
from src.myideas.swin_transformer.decode_heads.uper_head import UPerHead
from src.myideas.swin_transformer.decode_heads.fcn_head import FCNHead
...
class EncoderDecoder(nn.Module):
    ...
    def __init__(self, pretrained=None):
        ...
        self._init_decode_head(UPerHead())
        self._init_auxiliary_head(FCNHead())
